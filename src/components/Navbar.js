...
const Navbar = () => {
  return (
    <div className='md:w-[45%] w-[90%] text-md  absolute    font-semibold top-14 rounded-lg font-nunito border h-4 flex justify-evenly   border-green text-gray-100 items-center py-6'>
