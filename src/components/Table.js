            ...
            cryptoData.map((data)=>{
                return(
                  ...
                  <td className='p-4 flex'>
                    <button className='outline-0 border-none ' onClick={()=>{}} ><svg className='mr-2 fill-gray-100 hover:fill-grecyan' width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
